...
public class PseudostateImpl extends VertexImpl implements Pseudostate {
	 ...
	 * @ordered
	 */
	protected static final PseudostateKind KIND_EDEFAULT = PseudostateKind.FORK;
	...
	protected EClass eStaticClass() {
		return ForkpseudostatePackage.Literals.PSEUDOSTATE;
	}
	...
	public void setKind(PseudostateKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ForkpseudostatePackage.PSEUDOSTATE__KIND, oldKind, kind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ForkpseudostatePackage.PSEUDOSTATE__KIND:
				return getKind();
		}
