 ...
 * <ul>
 *   <li>{@link timedfsm.impl.TimedTransitionImpl#getTime <em>Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TimedTransitionImpl extends TransitionImpl implements TimedTransition {
	...
	protected EClass eStaticClass() {
		return TimedfsmPackage.Literals.TIMED_TRANSITION;
	}
	...
	public void setTime(int newTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TimedfsmPackage.TIMED_TRANSITION__TIME, oldTime, time));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TimedfsmPackage.TIMED_TRANSITION__TIME:
				return getTime();
		}
