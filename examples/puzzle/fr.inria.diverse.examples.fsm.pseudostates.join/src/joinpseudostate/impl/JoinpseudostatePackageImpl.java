...
import joinpseudostate.JoinpseudostateFactory;
 ...
 * @generated
 */
public class JoinpseudostatePackageImpl extends EPackageImpl implements JoinpseudostatePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see joinpseudostate.JoinpseudostatePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private JoinpseudostatePackageImpl() {
		super(eNS_URI, JoinpseudostateFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link JoinpseudostatePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static JoinpseudostatePackage init() {
		if (isInited) return (JoinpseudostatePackage)EPackage.Registry.INSTANCE.getEPackage(JoinpseudostatePackage.eNS_URI);

		// Obtain or create and register package
		JoinpseudostatePackageImpl theJoinpseudostatePackage = (JoinpseudostatePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof JoinpseudostatePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new JoinpseudostatePackageImpl());

		isInited = true;

		// Create package meta-data objects
		theJoinpseudostatePackage.createPackageContents();

		// Initialize created meta-data
		theJoinpseudostatePackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theJoinpseudostatePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(JoinpseudostatePackage.eNS_URI, theJoinpseudostatePackage);
		return theJoinpseudostatePackage;
	}
	 ...
	 * @generated
	 */
	public JoinpseudostateFactory getJoinpseudostateFactory() {
		return (JoinpseudostateFactory)getEFactoryInstance();
	}
