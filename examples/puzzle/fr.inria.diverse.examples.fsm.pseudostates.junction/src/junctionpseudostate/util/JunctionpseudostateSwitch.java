 ...
 * @generated
 */
public class JunctionpseudostateSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public JunctionpseudostateSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case JunctionpseudostatePackage.TRANSITION: {
			...
			case JunctionpseudostatePackage.TRIGGER: {
				Trigger trigger = (Trigger)theEObject;
				T result = caseTrigger(trigger);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JunctionpseudostatePackage.NAMED_ELEMENT: {
