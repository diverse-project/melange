 ...
 * </p>
 * <ul>
 *   <li>{@link junctionpseudostate.impl.PseudostateImpl#getKind <em>Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PseudostateImpl extends AbstractStateImpl implements Pseudostate {
	 ...
	 * @ordered
	 */
	protected static final PseudostateKind KIND_EDEFAULT = PseudostateKind.JUNCTION;
	...
	protected EClass eStaticClass() {
		return JunctionpseudostatePackage.Literals.PSEUDOSTATE;
	}
	...
	public void setKind(PseudostateKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JunctionpseudostatePackage.PSEUDOSTATE__KIND, oldKind, kind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JunctionpseudostatePackage.PSEUDOSTATE__KIND:
				return getKind();
		}
