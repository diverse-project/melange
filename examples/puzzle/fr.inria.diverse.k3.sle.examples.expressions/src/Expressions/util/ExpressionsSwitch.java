	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ExpressionsPackage.STATEMENT: {
				...
				if (result == null) result = caseExpression(statement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ExpressionsPackage.INTEGER_LIT: {
			...
			case ExpressionsPackage.STRING_LIT: {
			...
			case ExpressionsPackage.VAR_REFERENCE: {
