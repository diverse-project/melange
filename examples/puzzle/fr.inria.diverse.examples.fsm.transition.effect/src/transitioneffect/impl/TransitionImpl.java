 ...
 * <ul>
 *   <li>{@link transitioneffect.impl.TransitionImpl#getEffect <em>Effect</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TransitionImpl extends MinimalEObjectImpl.Container implements Transition {
	...
	protected EClass eStaticClass() {
		return TransitioneffectPackage.Literals.TRANSITION;
	}
	...
	public EList<Statement> getEffect() {
		if (effect == null) {
			effect = new EObjectContainmentEList<Statement>(Statement.class, this, TransitioneffectPackage.TRANSITION__EFFECT);
		}
		return effect;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TransitioneffectPackage.TRANSITION__EFFECT:
