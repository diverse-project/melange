 ...
 * @generated
 */
public class CompositestatesSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CompositestatesPackage.STATE: {
