 ...
 * @generated
 */
public class CompositestatesFactoryImpl extends EFactoryImpl implements CompositestatesFactory {
	/**
	 ...
	 * @generated
	 */
	public static CompositestatesFactory init() {
		try {
			CompositestatesFactory theCompositestatesFactory = (CompositestatesFactory)EPackage.Registry.INSTANCE.getEFactory(CompositestatesPackage.eNS_URI);
			if (theCompositestatesFactory != null) {
				return theCompositestatesFactory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new CompositestatesFactoryImpl();
	}
	 ...
	 * @generated
	 */
	public CompositestatesFactoryImpl() {
		super();
	}
	 ...
	 * @generated
	 */
	public CompositestatesPackage getCompositestatesPackage() {
		return (CompositestatesPackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static CompositestatesPackage getPackage() {
		return CompositestatesPackage.eINSTANCE;
	}

} //CompositestatesFactoryImpl
