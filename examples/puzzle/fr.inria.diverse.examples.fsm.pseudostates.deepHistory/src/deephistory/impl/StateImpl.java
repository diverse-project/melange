 ...
 * </p>
 * <ul>
 *   <li>{@link deephistory.impl.StateImpl#getOwnedRegions <em>Owned Regions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StateImpl extends AbstractStateImpl implements State {
	...
	protected EClass eStaticClass() {
		return DeephistoryPackage.Literals.STATE;
	}
	...
	public EList<Region> getOwnedRegions() {
		if (ownedRegions == null) {
			ownedRegions = new EObjectContainmentWithInverseEList<Region>(Region.class, this, DeephistoryPackage.STATE__OWNED_REGIONS, DeephistoryPackage.REGION__OWNER_STATE);
		}
		return ownedRegions;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DeephistoryPackage.STATE__OWNED_REGIONS:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case DeephistoryPackage.STATE___ENTRY_STATE__MAP:
