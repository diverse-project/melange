 ...
 * </p>
 * <ul>
 *   <li>{@link deephistory.impl.PseudostateImpl#getKind <em>Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PseudostateImpl extends AbstractStateImpl implements Pseudostate {
	 ...
	 * @ordered
	 */
	protected static final PseudostateKind KIND_EDEFAULT = PseudostateKind.DEEP_HISTORY;
	...
	protected EClass eStaticClass() {
		return DeephistoryPackage.Literals.PSEUDOSTATE;
	}
	...
	public void setKind(PseudostateKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeephistoryPackage.PSEUDOSTATE__KIND, oldKind, kind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DeephistoryPackage.PSEUDOSTATE__KIND:
				return getKind();
		}
