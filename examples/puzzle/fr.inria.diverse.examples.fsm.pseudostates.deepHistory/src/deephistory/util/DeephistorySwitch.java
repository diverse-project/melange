 ...
 * @generated
 */
public class DeephistorySwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DeephistoryPackage.PSEUDOSTATE: {
			...
			case DeephistoryPackage.NAMED_ELEMENT: {
