 ...
 * @generated
 */
public class ConditionalpseudostateSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ConditionalpseudostateSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ConditionalpseudostatePackage.ABSTRACT_STATE: {
				AbstractState abstractState = (AbstractState)theEObject;
				T result = caseAbstractState(abstractState);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConditionalpseudostatePackage.PSEUDOSTATE: {
			...
			case ConditionalpseudostatePackage.TRANSITION: {
				Transition transition = (Transition)theEObject;
				T result = caseTransition(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConditionalpseudostatePackage.NAMED_ELEMENT: {
