 ...
 * </p>
 * <ul>
 *   <li>{@link fsmcore.impl.PseudostateImpl#getKind <em>Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PseudostateImpl extends VertexImpl implements Pseudostate {
	...
	protected EClass eStaticClass() {
		return FsmcorePackage.Literals.PSEUDOSTATE;
	}
	...
	public void setKind(PseudostateKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmcorePackage.PSEUDOSTATE__KIND, oldKind, kind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FsmcorePackage.PSEUDOSTATE__KIND:
				return getKind();
		}
