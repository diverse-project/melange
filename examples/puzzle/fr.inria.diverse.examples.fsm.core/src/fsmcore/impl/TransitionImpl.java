...
public class TransitionImpl extends NamedElementImpl implements Transition {
	...
	public void setTarget(Vertex newTarget) {
		if (newTarget != target) {
			NotificationChain msgs = null;
			if (target != null)
				msgs = ((InternalEObject)target).eInverseRemove(this, FsmcorePackage.VERTEX__INCOMING, Vertex.class, msgs);
			if (newTarget != null)
				msgs = ((InternalEObject)newTarget).eInverseAdd(this, FsmcorePackage.VERTEX__INCOMING, Vertex.class, msgs);
	...
	public void setSource(Vertex newSource) {
		if (newSource != source) {
			...
			if (newSource != null)
				msgs = ((InternalEObject)newSource).eInverseAdd(this, FsmcorePackage.VERTEX__OUTGOING, Vertex.class, msgs);
