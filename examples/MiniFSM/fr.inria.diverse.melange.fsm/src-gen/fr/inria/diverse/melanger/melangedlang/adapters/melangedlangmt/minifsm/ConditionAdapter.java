...
public class ConditionAdapter extends EObjectAdapter<Condition> implements fr.inria.diverse.melanger.melangedlangmt.minifsm.Condition {
  ...
  public EClass eClass() {
    return fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.eINSTANCE.getCondition();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.CONDITION__EXPRESSION:
    		return getExpression();
    	case fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.CONDITION__LANGUAGE:
    		return getLanguage();
    }
