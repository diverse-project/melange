...
public class VariableAdapter extends EObjectAdapter<Variable> implements fr.inria.diverse.melanger.miniactionlangmt.minilang.Variable {
  ...
  public EClass eClass() {
    return fr.inria.diverse.melanger.miniactionlangmt.minilang.MinilangPackage.eINSTANCE.getVariable();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.melanger.miniactionlangmt.minilang.MinilangPackage.VARIABLE__NAME:
    		return getName();
    }
