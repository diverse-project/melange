...
public class MinifsmFactoryAdapter extends EFactoryImpl implements MinifsmFactory {
  private MiniFsmMTAdaptersFactory adaptersFactory = fr.inria.diverse.melanger.melangedlang.adapters.minifsmmt.MiniFsmMTAdaptersFactory.getInstance();
  
  private fr.inria.diverse.melanger.melangedlang.minifsm.MinifsmFactory minifsmAdaptee = fr.inria.diverse.melanger.melangedlang.minifsm.MinifsmFactory.eINSTANCE;
