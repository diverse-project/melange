...
public class MultiplyAdapter extends EObjectAdapter<Multiply> implements fr.inria.diverse.melanger.melangedlangmt.minifsm.Multiply {
  ...
  public int eval(final Context ctx) {
    return fr.inria.diverse.melanger.melangedlang.aspects.MultiplyAspect.eval(adaptee, ((fr.inria.diverse.melanger.melangedlang.adapters.melangedlangmt.minifsm.ContextAdapter) ctx).getAdaptee()
    );
  }
  
  @Override
  public EClass eClass() {
    return fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.eINSTANCE.getMultiply();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.MULTIPLY__RIGHT:
    		return getRight();
    	case fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.MULTIPLY__LEFT:
    		return getLeft();
    }
