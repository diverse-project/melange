...
public class TransitionAdapter extends EObjectAdapter<Transition> implements fr.inria.diverse.melanger.minifsmmt.minifsm.Transition {
  ...
  public void setInput(final State o) {
    if (o != null)
    	adaptee.setInput(((fr.inria.diverse.melanger.minifsm.adapters.minifsmmt.minifsm.StateAdapter) o).getAdaptee());
  ...
  public void setOutput(final State o) {
    if (o != null)
    	adaptee.setOutput(((fr.inria.diverse.melanger.minifsm.adapters.minifsmmt.minifsm.StateAdapter) o).getAdaptee());
