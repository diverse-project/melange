 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.minilang.impl.BooleanOperationImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link fr.inria.diverse.minilang.impl.BooleanOperationImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanOperationImpl extends BooleanExpressionImpl implements BooleanOperation {
	/**
	...
	protected EClass eStaticClass() {
		return MinilangPackage.Literals.BOOLEAN_OPERATION;
	}
	...
	public NotificationChain basicSetLeft(BooleanExpression newLeft, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MinilangPackage.BOOLEAN_OPERATION__LEFT, oldLeft, newLeft);
	...
	public void setLeft(BooleanExpression newLeft) {
		if (newLeft != left) {
			...
			if (left != null)
				msgs = ((InternalEObject)left).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MinilangPackage.BOOLEAN_OPERATION__LEFT, null, msgs);
			if (newLeft != null)
				msgs = ((InternalEObject)newLeft).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MinilangPackage.BOOLEAN_OPERATION__LEFT, null, msgs);
			msgs = basicSetLeft(newLeft, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MinilangPackage.BOOLEAN_OPERATION__LEFT, newLeft, newLeft));
	}
