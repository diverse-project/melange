 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.minilang.impl.VariableRefImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableRefImpl extends MinimalEObjectImpl.Container implements VariableRef {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MinilangPackage.VARIABLE_REF__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MinilangPackage.VARIABLE_REF__NAME:
				return getName();
		}
