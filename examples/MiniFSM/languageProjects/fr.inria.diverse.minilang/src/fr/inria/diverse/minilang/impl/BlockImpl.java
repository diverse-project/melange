 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.minilang.impl.BlockImpl#getStatement <em>Statement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BlockImpl extends MinimalEObjectImpl.Container implements Block {
	...
	public EList<Statement> getStatement() {
		if (statement == null) {
			statement = new EObjectContainmentEList<Statement>(Statement.class, this, MinilangPackage.BLOCK__STATEMENT);
		}
		return statement;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MinilangPackage.BLOCK__STATEMENT:
