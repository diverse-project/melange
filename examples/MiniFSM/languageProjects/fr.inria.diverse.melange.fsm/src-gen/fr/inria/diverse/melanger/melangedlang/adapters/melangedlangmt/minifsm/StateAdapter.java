...
public class StateAdapter extends EObjectAdapter<State> implements fr.inria.diverse.melanger.melangedlangmt.minifsm.State {
  ...
  public EClass eClass() {
    return fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.eINSTANCE.getState();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.STATE__NAME:
    		return getName();
    	case fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.STATE__FSM:
    		return getFsm();
    	case fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.STATE__BLOCK:
    		return getBlock();
    }
