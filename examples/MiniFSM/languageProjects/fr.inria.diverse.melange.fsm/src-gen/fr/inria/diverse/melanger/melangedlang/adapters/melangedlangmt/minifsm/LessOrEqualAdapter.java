...
public class LessOrEqualAdapter extends EObjectAdapter<LessOrEqual> implements fr.inria.diverse.melanger.melangedlangmt.minifsm.LessOrEqual {
  ...
  public boolean eval(final Context ctx) {
    return fr.inria.diverse.melanger.melangedlang.aspects.LessOrEqualAspect.eval(adaptee, ((fr.inria.diverse.melanger.melangedlang.adapters.melangedlangmt.minifsm.ContextAdapter) ctx).getAdaptee()
    );
  }
  
  @Override
  public EClass eClass() {
    return fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.eINSTANCE.getLessOrEqual();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.LESS_OR_EQUAL__RIGHT:
    		return getRight();
    	case fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.LESS_OR_EQUAL__LEFT:
    		return getLeft();
    }
