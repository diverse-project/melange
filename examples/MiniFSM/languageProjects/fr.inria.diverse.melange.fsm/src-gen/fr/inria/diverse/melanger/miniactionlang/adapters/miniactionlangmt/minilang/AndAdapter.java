...
public class AndAdapter extends EObjectAdapter<And> implements fr.inria.diverse.melanger.miniactionlangmt.minilang.And {
  ...
  public boolean eval(final Context ctx) {
    return fr.inria.diverse.melanger.miniactionlang.aspects.AndAspect.eval(adaptee, ((fr.inria.diverse.melanger.miniactionlang.adapters.miniactionlangmt.minilang.ContextAdapter) ctx).getAdaptee()
    );
  }
  
  @Override
  public EClass eClass() {
    return fr.inria.diverse.melanger.miniactionlangmt.minilang.MinilangPackage.eINSTANCE.getAnd();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.melanger.miniactionlangmt.minilang.MinilangPackage.AND__LEFT:
    		return getLeft();
    	case fr.inria.diverse.melanger.miniactionlangmt.minilang.MinilangPackage.AND__RIGHT:
    		return getRight();
    }
