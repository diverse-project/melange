...
public class FinalStateAdapter extends EObjectAdapter<FinalState> implements fr.inria.diverse.melanger.minifsmmt.minifsm.FinalState {
  ...
  public void setFsm(final FSM o) {
    if (o != null)
    	adaptee.setFsm(((fr.inria.diverse.melanger.minifsm.adapters.minifsmmt.minifsm.FSMAdapter) o).getAdaptee());
    else adaptee.setFsm(null);
  }
  
  @Override
  public void execute() {
    minifsm.aspects.FinalStateAspect.execute(adaptee);
  }
  ...
  public EClass eClass() {
    return fr.inria.diverse.melanger.minifsmmt.minifsm.MinifsmPackage.eINSTANCE.getFinalState();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.melanger.minifsmmt.minifsm.MinifsmPackage.FINAL_STATE__NAME:
    		return getName();
    	case fr.inria.diverse.melanger.minifsmmt.minifsm.MinifsmPackage.FINAL_STATE__FSM:
    		return getFsm();
    }
