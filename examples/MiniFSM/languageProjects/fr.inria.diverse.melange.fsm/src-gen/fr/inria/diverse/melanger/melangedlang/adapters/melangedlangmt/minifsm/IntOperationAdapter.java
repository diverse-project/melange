...
public class IntOperationAdapter extends EObjectAdapter<IntOperation> implements fr.inria.diverse.melanger.melangedlangmt.minifsm.IntOperation {
  ...
  public EClass eClass() {
    return fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.eINSTANCE.getIntOperation();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.INT_OPERATION__RIGHT:
    		return getRight();
    	case fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.INT_OPERATION__LEFT:
    		return getLeft();
    }
