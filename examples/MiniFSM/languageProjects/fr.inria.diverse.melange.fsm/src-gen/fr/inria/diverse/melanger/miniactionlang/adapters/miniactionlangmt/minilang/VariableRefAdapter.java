...
public class VariableRefAdapter extends EObjectAdapter<VariableRef> implements fr.inria.diverse.melanger.miniactionlangmt.minilang.VariableRef {
  ...
  public EClass eClass() {
    return fr.inria.diverse.melanger.miniactionlangmt.minilang.MinilangPackage.eINSTANCE.getVariableRef();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.melanger.miniactionlangmt.minilang.MinilangPackage.VARIABLE_REF__NAME:
    		return getName();
    }
