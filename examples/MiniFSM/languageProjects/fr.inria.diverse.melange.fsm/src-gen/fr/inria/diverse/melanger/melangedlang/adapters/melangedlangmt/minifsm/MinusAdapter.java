...
public class MinusAdapter extends EObjectAdapter<Minus> implements fr.inria.diverse.melanger.melangedlangmt.minifsm.Minus {
  ...
  public int eval(final Context ctx) {
    return fr.inria.diverse.melanger.melangedlang.aspects.MinusAspect.eval(adaptee, ((fr.inria.diverse.melanger.melangedlang.adapters.melangedlangmt.minifsm.ContextAdapter) ctx).getAdaptee()
    );
  }
  
  @Override
  public EClass eClass() {
    return fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.eINSTANCE.getMinus();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.MINUS__RIGHT:
    		return getRight();
    	case fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.MINUS__LEFT:
    		return getLeft();
    }
