...
public class VariableRefAdapter extends EObjectAdapter<VariableRef> implements fr.inria.diverse.melanger.melangedlangmt.minifsm.VariableRef {
  ...
  public EClass eClass() {
    return fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.eINSTANCE.getVariableRef();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.VARIABLE_REF__NAME:
    		return getName();
    }
