...
public class StatementAdapter extends EObjectAdapter<Statement> implements fr.inria.diverse.melanger.melangedlangmt.minifsm.Statement {
  ...
  public void execute(final Context ctx) {
    fr.inria.diverse.melanger.melangedlang.aspects.StatementAspect.execute(adaptee, ((fr.inria.diverse.melanger.melangedlang.adapters.melangedlangmt.minifsm.ContextAdapter) ctx).getAdaptee()
    );
  }
  
  @Override
  public EClass eClass() {
    return fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.eINSTANCE.getStatement();
  }
}
