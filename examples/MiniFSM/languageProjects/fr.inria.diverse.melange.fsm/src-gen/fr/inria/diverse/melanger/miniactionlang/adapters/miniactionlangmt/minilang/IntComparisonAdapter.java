...
public class IntComparisonAdapter extends EObjectAdapter<IntComparison> implements fr.inria.diverse.melanger.miniactionlangmt.minilang.IntComparison {
  private MiniActionLangMTAdaptersFactory adaptersFactory;
  
  public IntComparisonAdapter() {
  ...
  public EClass eClass() {
    return fr.inria.diverse.melanger.miniactionlangmt.minilang.MinilangPackage.eINSTANCE.getIntComparison();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.melanger.miniactionlangmt.minilang.MinilangPackage.INT_COMPARISON__RIGHT:
    		return getRight();
    	case fr.inria.diverse.melanger.miniactionlangmt.minilang.MinilangPackage.INT_COMPARISON__LEFT:
    		return getLeft();
    }
