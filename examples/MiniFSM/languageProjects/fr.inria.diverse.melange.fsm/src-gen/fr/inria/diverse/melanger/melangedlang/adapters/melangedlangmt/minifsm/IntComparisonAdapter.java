...
public class IntComparisonAdapter extends EObjectAdapter<IntComparison> implements fr.inria.diverse.melanger.melangedlangmt.minifsm.IntComparison {
  ...
  public EClass eClass() {
    return fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.eINSTANCE.getIntComparison();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.INT_COMPARISON__RIGHT:
    		return getRight();
    	case fr.inria.diverse.melanger.melangedlangmt.minifsm.MinifsmPackage.INT_COMPARISON__LEFT:
    		return getLeft();
    }
