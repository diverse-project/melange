...
public class DivideAdapter extends EObjectAdapter<Divide> implements fr.inria.diverse.melanger.miniactionlangmt.minilang.Divide {
  ...
  public int eval(final Context ctx) {
    return fr.inria.diverse.melanger.miniactionlang.aspects.DivideAspect.eval(adaptee, ((fr.inria.diverse.melanger.miniactionlang.adapters.miniactionlangmt.minilang.ContextAdapter) ctx).getAdaptee()
    );
  }
  
  @Override
  public EClass eClass() {
    return fr.inria.diverse.melanger.miniactionlangmt.minilang.MinilangPackage.eINSTANCE.getDivide();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.melanger.miniactionlangmt.minilang.MinilangPackage.DIVIDE__RIGHT:
    		return getRight();
    	case fr.inria.diverse.melanger.miniactionlangmt.minilang.MinilangPackage.DIVIDE__LEFT:
    		return getLeft();
    }
