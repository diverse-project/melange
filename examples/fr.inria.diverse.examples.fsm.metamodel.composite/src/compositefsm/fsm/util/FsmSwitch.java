 ...
 * <!-- end-user-doc -->
 * @see compositefsm.fsm.FsmPackage
 * @generated
 */
public class FsmSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FsmPackage.TIMED_TRANSITION: {
			...
			case FsmPackage.COMPOSITE_STATE: {
			...
			case FsmPackage.CHOICE: {
				...
				if (result == null) result = caseState(choice);
