 ...
 * </p>
 * <ul>
 *   <li>{@link compositefsm.fsm.impl.StateMachineImpl#getStates <em>States</em>}</li>
 *   <li>{@link compositefsm.fsm.impl.StateMachineImpl#getTransitions <em>Transitions</em>}</li>
 *   <li>{@link compositefsm.fsm.impl.StateMachineImpl#getVariables <em>Variables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StateMachineImpl extends NamedElementImpl implements StateMachine {
	...
	public EList<Transition> getTransitions() {
		if (transitions == null) {
			transitions = new EObjectContainmentWithInverseEList<Transition>(Transition.class, this, FsmPackage.STATE_MACHINE__TRANSITIONS, FsmPackage.TRANSITION__STATE_MACHINE);
		}
		return transitions;
	}
