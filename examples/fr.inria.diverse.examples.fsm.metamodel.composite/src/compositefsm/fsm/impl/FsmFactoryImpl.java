...
public class FsmFactoryImpl extends EFactoryImpl implements FsmFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case FsmPackage.TIMED_TRANSITION: return createTimedTransition();
			...
			case FsmPackage.COMPOSITE_STATE: return createCompositeState();
			case FsmPackage.REGION: return createRegion();
			case FsmPackage.ACTION: return createAction();
			case FsmPackage.VARIABLE: return createVariable();
