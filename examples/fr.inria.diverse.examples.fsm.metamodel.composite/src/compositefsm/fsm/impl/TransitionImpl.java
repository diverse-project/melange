 ...
 * </p>
 * <ul>
 *   <li>{@link compositefsm.fsm.impl.TransitionImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link compositefsm.fsm.impl.TransitionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link compositefsm.fsm.impl.TransitionImpl#getTrigger <em>Trigger</em>}</li>
 *   <li>{@link compositefsm.fsm.impl.TransitionImpl#getStateMachine <em>State Machine</em>}</li>
 *   <li>{@link compositefsm.fsm.impl.TransitionImpl#getInitialTime <em>Initial Time</em>}</li>
 *   <li>{@link compositefsm.fsm.impl.TransitionImpl#getFinalTime <em>Final Time</em>}</li>
 *   <li>{@link compositefsm.fsm.impl.TransitionImpl#getGuard <em>Guard</em>}</li>
 *   <li>{@link compositefsm.fsm.impl.TransitionImpl#getAction <em>Action</em>}</li>
 * </ul>
 *
 * @generated
 */
