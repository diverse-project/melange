 ...
 * @generated
 */
public class FinitestatemachinescompositePackageImpl extends EPackageImpl implements FinitestatemachinescompositePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see finitestatemachinescomposite.FinitestatemachinescompositePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private FinitestatemachinescompositePackageImpl() {
		super(eNS_URI, FinitestatemachinescompositeFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link FinitestatemachinescompositePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static FinitestatemachinescompositePackage init() {
		if (isInited) return (FinitestatemachinescompositePackage)EPackage.Registry.INSTANCE.getEPackage(FinitestatemachinescompositePackage.eNS_URI);

		// Obtain or create and register package
		FinitestatemachinescompositePackageImpl theFinitestatemachinescompositePackage = (FinitestatemachinescompositePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof FinitestatemachinescompositePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new FinitestatemachinescompositePackageImpl());

		isInited = true;

		// Create package meta-data objects
		theFinitestatemachinescompositePackage.createPackageContents();

		// Initialize created meta-data
		theFinitestatemachinescompositePackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theFinitestatemachinescompositePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(FinitestatemachinescompositePackage.eNS_URI, theFinitestatemachinescompositePackage);
		return theFinitestatemachinescompositePackage;
	}
	 ...
	 * @generated
	 */
	public FinitestatemachinescompositeFactory getFinitestatemachinescompositeFactory() {
		return (FinitestatemachinescompositeFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getAction_Value(), ecorePackage.getEBoolean(), "value", null, 0, 1, Action.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(variableEClass, Variable.class, "Variable", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getVariable_Name(), ecorePackage.getEString(), "name", null, 0, 1, Variable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVariable_Value(), ecorePackage.getEBoolean(), "value", null, 0, 1, Variable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
...
} //FinitestatemachinescompositePackageImpl
