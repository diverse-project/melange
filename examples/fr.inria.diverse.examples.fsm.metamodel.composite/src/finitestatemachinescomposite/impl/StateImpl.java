...
public class StateImpl extends NamedElementImpl implements State {
		...
		if (stateMachine != null && stateMachine.eIsProxy()) {
			...
			if (stateMachine != oldStateMachine) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FinitestatemachinescompositePackage.STATE__STATE_MACHINE, oldStateMachine, stateMachine));
			}
		}
		return stateMachine;
	}
	...
	public void setStateMachine(StateMachine newStateMachine) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FinitestatemachinescompositePackage.STATE__STATE_MACHINE, oldStateMachine, stateMachine));
	}
