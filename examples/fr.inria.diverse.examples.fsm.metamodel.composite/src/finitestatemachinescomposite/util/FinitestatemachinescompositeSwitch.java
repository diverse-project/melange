 ...
 * @generated
 */
public class FinitestatemachinescompositeSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public FinitestatemachinescompositeSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FinitestatemachinescompositePackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FinitestatemachinescompositePackage.STATE_MACHINE: {
			...
			case FinitestatemachinescompositePackage.STATE: {
			...
			case FinitestatemachinescompositePackage.FINAL_STATE: {
			...
			case FinitestatemachinescompositePackage.INITIAL_STATE: {
			...
			case FinitestatemachinescompositePackage.TRANSITION: {
			...
			case FinitestatemachinescompositePackage.TIMED_TRANSITION: {
			...
			case FinitestatemachinescompositePackage.TRIGGER: {
				Trigger trigger = (Trigger)theEObject;
				T result = caseTrigger(trigger);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FinitestatemachinescompositePackage.PSEUDOSTATE: {
			...
			case FinitestatemachinescompositePackage.FORK: {
			...
			case FinitestatemachinescompositePackage.JOIN: {
			...
			case FinitestatemachinescompositePackage.COMPOSITE_STATE: {
			...
			case FinitestatemachinescompositePackage.REGION: {
...
} //FinitestatemachinescompositeSwitch
