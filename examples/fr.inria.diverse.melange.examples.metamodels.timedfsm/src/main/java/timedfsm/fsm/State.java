 ...
 * <ul>
 *   <li>{@link timedfsm.fsm.State#getOwningFSM <em>Owning FSM</em>}</li>
 *   <li>{@link timedfsm.fsm.State#getName <em>Name</em>}</li>
 *   <li>{@link timedfsm.fsm.State#getOutgoingTransition <em>Outgoing Transition</em>}</li>
 *   <li>{@link timedfsm.fsm.State#getIncomingTransition <em>Incoming Transition</em>}</li>
 * </ul>
 * </p>
 *
 * @see timedfsm.fsm.TimedfsmPackage#getState()
 * @model
 * @generated
 */
public interface State extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link timedfsm.fsm.FSM#getOwnedState <em>Owned State</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see timedfsm.fsm.TimedfsmPackage#getState_OwningFSM()
	...
	/**
	 * Sets the value of the '{@link timedfsm.fsm.State#getOwningFSM <em>Owning FSM</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see timedfsm.fsm.TimedfsmPackage#getState_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link timedfsm.fsm.State#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see timedfsm.fsm.TimedfsmPackage#getState_OutgoingTransition()
	 ...
	 * @see timedfsm.fsm.TimedfsmPackage#getState_IncomingTransition()
