 ...
 * <ul>
 *   <li>{@link timedfsm.fsm.impl.FSMImpl#getOwnedState <em>Owned State</em>}</li>
 *   <li>{@link timedfsm.fsm.impl.FSMImpl#getInitialState <em>Initial State</em>}</li>
 *   <li>{@link timedfsm.fsm.impl.FSMImpl#getFinalState <em>Final State</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FSMImpl extends MinimalEObjectImpl.Container implements FSM {
	...
	protected EClass eStaticClass() {
		return TimedfsmPackage.Literals.FSM;
	}
	...
	public EList<State> getOwnedState() {
		if (ownedState == null) {
			ownedState = new EObjectContainmentWithInverseEList<State>(State.class, this, TimedfsmPackage.FSM__OWNED_STATE, TimedfsmPackage.STATE__OWNING_FSM);
		}
		return ownedState;
	}
		...
		if (initialState != null && initialState.eIsProxy()) {
			...
			if (initialState != oldInitialState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TimedfsmPackage.FSM__INITIAL_STATE, oldInitialState, initialState));
			}
		}
		return initialState;
	}
	...
	public void setInitialState(State newInitialState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TimedfsmPackage.FSM__INITIAL_STATE, oldInitialState, initialState));
	}
	...
	public EList<State> getFinalState() {
		if (finalState == null) {
			finalState = new EObjectResolvingEList<State>(State.class, this, TimedfsmPackage.FSM__FINAL_STATE);
		}
		return finalState;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TimedfsmPackage.FSM__OWNED_STATE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TimedfsmPackage.FSM__INITIAL_STATE:
				if (resolve) return getInitialState();
				return basicGetInitialState();
			case TimedfsmPackage.FSM__FINAL_STATE:
