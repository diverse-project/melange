...
import finitestatemachinestimedcomposite.FinitestatemachinestimedcompositeFactory;
...
import finitestatemachinestimedcomposite.NamedElement;
...
import finitestatemachinestimedcomposite.TimedTransition;
 ...
 * @generated
 */
public class FinitestatemachinestimedcompositePackageImpl extends EPackageImpl implements FinitestatemachinestimedcompositePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see finitestatemachinestimedcomposite.FinitestatemachinestimedcompositePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private FinitestatemachinestimedcompositePackageImpl() {
		super(eNS_URI, FinitestatemachinestimedcompositeFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link FinitestatemachinestimedcompositePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static FinitestatemachinestimedcompositePackage init() {
		if (isInited) return (FinitestatemachinestimedcompositePackage)EPackage.Registry.INSTANCE.getEPackage(FinitestatemachinestimedcompositePackage.eNS_URI);

		// Obtain or create and register package
		FinitestatemachinestimedcompositePackageImpl theFinitestatemachinestimedcompositePackage = (FinitestatemachinestimedcompositePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof FinitestatemachinestimedcompositePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new FinitestatemachinestimedcompositePackageImpl());

		isInited = true;

		// Create package meta-data objects
		theFinitestatemachinestimedcompositePackage.createPackageContents();

		// Initialize created meta-data
		theFinitestatemachinestimedcompositePackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theFinitestatemachinestimedcompositePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(FinitestatemachinestimedcompositePackage.eNS_URI, theFinitestatemachinestimedcompositePackage);
		return theFinitestatemachinestimedcompositePackage;
	}
	 ...
	 * @generated
	 */
	public FinitestatemachinestimedcompositeFactory getFinitestatemachinestimedcompositeFactory() {
		return (FinitestatemachinestimedcompositeFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getState_ParentState(), this.getCompositeState(), null, "parentState", null, 0, 1, State.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRegion_States(), this.getState(), null, "states", null, 0, -1, Region.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRegion_Parent(), this.getCompositeState(), null, "parent", null, 1, 1, Region.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Create resource
		createResource(eNS_URI);
	}

} //FinitestatemachinestimedcompositePackageImpl
