 ...
 * <ul>
 *   <li>{@link finitestatemachinescomposite.impl.CompositeStateImpl#getRegions <em>Regions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompositeStateImpl extends StateImpl implements CompositeState {
	...
	protected EClass eStaticClass() {
		return FinitestatemachinescompositePackage.Literals.COMPOSITE_STATE;
	}
	...
	public EList<Region> getRegions() {
		if (regions == null) {
			regions = new EObjectContainmentEList<Region>(Region.class, this, FinitestatemachinescompositePackage.COMPOSITE_STATE__REGIONS);
		}
		return regions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FinitestatemachinescompositePackage.COMPOSITE_STATE__REGIONS:
