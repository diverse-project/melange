 ...
 * <ul>
 *   <li>{@link simplefsm.impl.TransitionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link simplefsm.impl.TransitionImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TransitionImpl extends MinimalEObjectImpl.Container implements Transition {
	...
	public void setSource(State newSource) {
		if (newSource != eInternalContainer() || (eContainerFeatureID() != SimplefsmPackage.TRANSITION__SOURCE && newSource != null)) {
			...
			if (newSource != null)
				msgs = ((InternalEObject)newSource).eInverseAdd(this, SimplefsmPackage.STATE__OUTGOING_TRANSITION, State.class, msgs);
	...
	public void setTarget(State newTarget) {
		if (newTarget != target) {
			NotificationChain msgs = null;
			if (target != null)
				msgs = ((InternalEObject)target).eInverseRemove(this, SimplefsmPackage.STATE__INCOMING_TRANSITION, State.class, msgs);
			if (newTarget != null)
				msgs = ((InternalEObject)newTarget).eInverseAdd(this, SimplefsmPackage.STATE__INCOMING_TRANSITION, State.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case SimplefsmPackage.TRANSITION__SOURCE:
				return eInternalContainer().eInverseRemove(this, SimplefsmPackage.STATE__OUTGOING_TRANSITION, State.class, msgs);
		}
