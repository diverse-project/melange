 ...
 * @generated
 */
public class FinitestatemachinestimedSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public FinitestatemachinestimedSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FinitestatemachinestimedPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FinitestatemachinestimedPackage.STATE_MACHINE: {
			...
			case FinitestatemachinestimedPackage.STATE: {
			...
			case FinitestatemachinestimedPackage.FINAL_STATE: {
			...
			case FinitestatemachinestimedPackage.INITIAL_STATE: {
			...
			case FinitestatemachinestimedPackage.TRANSITION: {
			...
			case FinitestatemachinestimedPackage.TIMED_TRANSITION: {
			...
			case FinitestatemachinestimedPackage.TRIGGER: {
				Trigger trigger = (Trigger)theEObject;
				T result = caseTrigger(trigger);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FinitestatemachinestimedPackage.PSEUDOSTATE: {
			...
			case FinitestatemachinestimedPackage.FORK: {
			...
			case FinitestatemachinestimedPackage.JOIN: {
...
} //FinitestatemachinestimedSwitch
