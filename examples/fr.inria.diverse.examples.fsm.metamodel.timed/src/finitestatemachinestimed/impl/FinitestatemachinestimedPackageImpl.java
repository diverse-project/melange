...
import finitestatemachinestimed.FinitestatemachinestimedFactory;
...
import finitestatemachinestimed.NamedElement;
...
import finitestatemachinestimed.TimedTransition;
 ...
 * @generated
 */
public class FinitestatemachinestimedPackageImpl extends EPackageImpl implements FinitestatemachinestimedPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see finitestatemachinestimed.FinitestatemachinestimedPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private FinitestatemachinestimedPackageImpl() {
		super(eNS_URI, FinitestatemachinestimedFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link FinitestatemachinestimedPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static FinitestatemachinestimedPackage init() {
		if (isInited) return (FinitestatemachinestimedPackage)EPackage.Registry.INSTANCE.getEPackage(FinitestatemachinestimedPackage.eNS_URI);

		// Obtain or create and register package
		FinitestatemachinestimedPackageImpl theFinitestatemachinestimedPackage = (FinitestatemachinestimedPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof FinitestatemachinestimedPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new FinitestatemachinestimedPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theFinitestatemachinestimedPackage.createPackageContents();

		// Initialize created meta-data
		theFinitestatemachinestimedPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theFinitestatemachinestimedPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(FinitestatemachinestimedPackage.eNS_URI, theFinitestatemachinestimedPackage);
		return theFinitestatemachinestimedPackage;
	}
	 ...
	 * @generated
	 */
	public FinitestatemachinestimedFactory getFinitestatemachinestimedFactory() {
		return (FinitestatemachinestimedFactory)getEFactoryInstance();
	}
...
} //FinitestatemachinestimedPackageImpl
