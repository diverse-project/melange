 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.iot2.iot2.iot2.impl.ContainedImpl#getRepositoryId <em>Repository Id</em>}</li>
 *   <li>{@link fr.inria.diverse.iot2.iot2.iot2.impl.ContainedImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link fr.inria.diverse.iot2.iot2.iot2.impl.ContainedImpl#getAbsoluteName <em>Absolute Name</em>}</li>
 *   <li>{@link fr.inria.diverse.iot2.iot2.iot2.impl.ContainedImpl#getDefinedIn <em>Defined In</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ContainedImpl extends NamedElementImpl implements Contained {
	...
	protected EClass eStaticClass() {
		return Iot2Package.Literals.CONTAINED;
	}
	...
	public void setRepositoryId(String newRepositoryId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Iot2Package.CONTAINED__REPOSITORY_ID, oldRepositoryId, repositoryId));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Iot2Package.CONTAINED__VERSION, oldVersion, version));
	}
	...
	public void setAbsoluteName(String newAbsoluteName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Iot2Package.CONTAINED__ABSOLUTE_NAME, oldAbsoluteName, absoluteName));
	}
	...
	public Container getDefinedIn() {
		if (eContainerFeatureID() != Iot2Package.CONTAINED__DEFINED_IN) return null;
	...
	public NotificationChain basicSetDefinedIn(Container newDefinedIn, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newDefinedIn, Iot2Package.CONTAINED__DEFINED_IN, msgs);
		return msgs;
	}
	...
	public void setDefinedIn(Container newDefinedIn) {
		if (newDefinedIn != eInternalContainer() || (eContainerFeatureID() != Iot2Package.CONTAINED__DEFINED_IN && newDefinedIn != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Iot2Package.CONTAINED__DEFINED_IN, newDefinedIn, newDefinedIn));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Iot2Package.CONTAINED__DEFINED_IN:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Iot2Package.CONTAINED__REPOSITORY_ID:
				return getRepositoryId();
			case Iot2Package.CONTAINED__VERSION:
				return getVersion();
			case Iot2Package.CONTAINED__ABSOLUTE_NAME:
