 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.iot2.iot2.iot2.impl.ControlFlowImpl#getGuard <em>Guard</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ControlFlowImpl extends ActivityEdgeImpl implements ControlFlow {
	...
	protected EClass eStaticClass() {
		return Iot2Package.Literals.CONTROL_FLOW;
	}
		...
		if (guard != null && guard.eIsProxy()) {
			...
			if (guard != oldGuard) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Iot2Package.CONTROL_FLOW__GUARD, oldGuard, guard));
			}
		}
		return guard;
	}
	...
	public void setGuard(BooleanVariable newGuard) {
		...
		guard = newGuard;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Iot2Package.CONTROL_FLOW__GUARD, oldGuard, guard));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Iot2Package.CONTROL_FLOW__GUARD:
