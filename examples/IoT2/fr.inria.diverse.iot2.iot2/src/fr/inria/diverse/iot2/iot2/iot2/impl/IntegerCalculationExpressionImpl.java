 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.iot2.iot2.iot2.impl.IntegerCalculationExpressionImpl#getAssignee <em>Assignee</em>}</li>
 *   <li>{@link fr.inria.diverse.iot2.iot2.iot2.impl.IntegerCalculationExpressionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerCalculationExpressionImpl extends IntegerExpressionImpl implements IntegerCalculationExpression {
	...
	protected EClass eStaticClass() {
		return Iot2Package.Literals.INTEGER_CALCULATION_EXPRESSION;
	}
		...
		if (assignee != null && assignee.eIsProxy()) {
			...
			if (assignee != oldAssignee) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Iot2Package.INTEGER_CALCULATION_EXPRESSION__ASSIGNEE, oldAssignee, assignee));
			}
		}
		return assignee;
	}
	...
	public void setAssignee(IntegerVariable newAssignee) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Iot2Package.INTEGER_CALCULATION_EXPRESSION__ASSIGNEE, oldAssignee, assignee));
	}
	...
	public void setOperator(IntegerCalculationOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Iot2Package.INTEGER_CALCULATION_EXPRESSION__OPERATOR, oldOperator, operator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Iot2Package.INTEGER_CALCULATION_EXPRESSION__ASSIGNEE:
				if (resolve) return getAssignee();
				return basicGetAssignee();
			case Iot2Package.INTEGER_CALCULATION_EXPRESSION__OPERATOR:
				return getOperator();
		}
