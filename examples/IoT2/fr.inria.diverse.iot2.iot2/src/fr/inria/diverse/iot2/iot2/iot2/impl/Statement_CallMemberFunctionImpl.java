 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.iot2.iot2.iot2.impl.Statement_CallMemberFunctionImpl#getObject <em>Object</em>}</li>
 *   <li>{@link fr.inria.diverse.iot2.iot2.iot2.impl.Statement_CallMemberFunctionImpl#getMemberFunctionName <em>Member Function Name</em>}</li>
 *   <li>{@link fr.inria.diverse.iot2.iot2.iot2.impl.Statement_CallMemberFunctionImpl#getArguments <em>Arguments</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Statement_CallMemberFunctionImpl extends Statement_FunctioncallOrAssignmentImpl implements Statement_CallMemberFunction {
	...
	protected EClass eStaticClass() {
		return Iot2Package.Literals.STATEMENT_CALL_MEMBER_FUNCTION;
	}
	...
	public NotificationChain basicSetObject(Expression newObject, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Iot2Package.STATEMENT_CALL_MEMBER_FUNCTION__OBJECT, oldObject, newObject);
	...
	public void setObject(Expression newObject) {
		if (newObject != object) {
			...
			if (object != null)
				msgs = ((InternalEObject)object).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Iot2Package.STATEMENT_CALL_MEMBER_FUNCTION__OBJECT, null, msgs);
			if (newObject != null)
				msgs = ((InternalEObject)newObject).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Iot2Package.STATEMENT_CALL_MEMBER_FUNCTION__OBJECT, null, msgs);
			msgs = basicSetObject(newObject, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Iot2Package.STATEMENT_CALL_MEMBER_FUNCTION__OBJECT, newObject, newObject));
	}
	...
	public void setMemberFunctionName(String newMemberFunctionName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Iot2Package.STATEMENT_CALL_MEMBER_FUNCTION__MEMBER_FUNCTION_NAME, oldMemberFunctionName, memberFunctionName));
	}
	...
	public NotificationChain basicSetArguments(Functioncall_Arguments newArguments, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Iot2Package.STATEMENT_CALL_MEMBER_FUNCTION__ARGUMENTS, oldArguments, newArguments);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setArguments(Functioncall_Arguments newArguments) {
		if (newArguments != arguments) {
			NotificationChain msgs = null;
			if (arguments != null)
				msgs = ((InternalEObject)arguments).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Iot2Package.STATEMENT_CALL_MEMBER_FUNCTION__ARGUMENTS, null, msgs);
			if (newArguments != null)
				msgs = ((InternalEObject)newArguments).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Iot2Package.STATEMENT_CALL_MEMBER_FUNCTION__ARGUMENTS, null, msgs);
			msgs = basicSetArguments(newArguments, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Iot2Package.STATEMENT_CALL_MEMBER_FUNCTION__ARGUMENTS, newArguments, newArguments));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Iot2Package.STATEMENT_CALL_MEMBER_FUNCTION__OBJECT:
				return basicSetObject(null, msgs);
			case Iot2Package.STATEMENT_CALL_MEMBER_FUNCTION__ARGUMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Iot2Package.STATEMENT_CALL_MEMBER_FUNCTION__OBJECT:
				return getObject();
			case Iot2Package.STATEMENT_CALL_MEMBER_FUNCTION__MEMBER_FUNCTION_NAME:
