 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.iot2.iot2.iot2.impl.PrimitiveDefImpl#getKind <em>Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimitiveDefImpl extends IDLTypeImpl implements PrimitiveDef {
	...
	protected EClass eStaticClass() {
		return Iot2Package.Literals.PRIMITIVE_DEF;
	}
	...
	public void setKind(PrimitiveKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Iot2Package.PRIMITIVE_DEF__KIND, oldKind, kind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Iot2Package.PRIMITIVE_DEF__KIND:
				return getKind();
		}
