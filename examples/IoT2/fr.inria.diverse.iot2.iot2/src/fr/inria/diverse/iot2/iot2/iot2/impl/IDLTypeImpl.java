 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.iot2.iot2.iot2.impl.IDLTypeImpl#getTypeCode <em>Type Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class IDLTypeImpl extends EObjectImpl implements IDLType {
	...
	protected EClass eStaticClass() {
		return Iot2Package.Literals.IDL_TYPE;
	}
	...
	public void setTypeCode(String newTypeCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Iot2Package.IDL_TYPE__TYPE_CODE, oldTypeCode, typeCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Iot2Package.IDL_TYPE__TYPE_CODE:
				return getTypeCode();
		}
