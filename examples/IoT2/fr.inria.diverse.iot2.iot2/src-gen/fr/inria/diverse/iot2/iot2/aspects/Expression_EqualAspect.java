...
@Aspect(className = Expression_Equal.class)
@SuppressWarnings("all")
public class Expression_EqualAspect extends LuaExpressionAspect {
  public static void execute(final Expression_Equal _self, final Environment c) {
    fr.inria.diverse.iot2.iot2.aspects.Expression_EqualAspectExpression_EqualAspectProperties _self_ = fr.inria.diverse.iot2.iot2.aspects.Expression_EqualAspectExpression_EqualAspectContext.getSelf(_self);
     if (_self instanceof fr.inria.diverse.iot2.iot2.iot2.Expression_Equal){
     fr.inria.diverse.iot2.iot2.aspects.Expression_EqualAspect._privk3_execute(_self_, (fr.inria.diverse.iot2.iot2.iot2.Expression_Equal)_self,c);
  ...
  protected static void _privk3_execute(final Expression_EqualAspectExpression_EqualAspectProperties _self_, final Expression_Equal _self, final Environment c) {
    ...
    c.pushValue(Boolean.valueOf(_equals));
  }
}
