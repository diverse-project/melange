...
public class LuaExpressionAspect extends Statement_FunctioncallOrAssignmentAspect {
  public static void execute(final Expression _self, final Environment c) {
    fr.inria.diverse.iot2.iot2.aspects.LuaExpressionAspectExpressionAspectProperties _self_ = fr.inria.diverse.iot2.iot2.aspects.LuaExpressionAspectExpressionAspectContext.getSelf(_self);
     ...
     fr.inria.diverse.iot2.iot2.aspects.LuaExpressionAspect._privk3_execute(_self_, (fr.inria.diverse.iot2.iot2.iot2.Expression)_self,c);
  ...
  protected static void _privk3_execute(final LuaExpressionAspectExpressionAspectProperties _self_, final Expression _self, final Environment c) {
  }
}
