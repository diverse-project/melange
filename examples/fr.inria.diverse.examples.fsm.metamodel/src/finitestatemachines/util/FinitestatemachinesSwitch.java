/**
 */
package finitestatemachines.util;
 ...
 * <!-- end-user-doc -->
 * @see finitestatemachines.FinitestatemachinesPackage
 * @generated
 */
public class FinitestatemachinesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FinitestatemachinesPackage.TRIGGER: {
			...
			case FinitestatemachinesPackage.JOIN: {
