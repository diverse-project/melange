 ...
 * <ul>
 *   <li>{@link finitestatemachines.impl.TransitionImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link finitestatemachines.impl.TransitionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link finitestatemachines.impl.TransitionImpl#getTrigger <em>Trigger</em>}</li>
 *   <li>{@link finitestatemachines.impl.TransitionImpl#getStateMachine <em>State Machine</em>}</li>
 *   <li>{@link finitestatemachines.impl.TransitionImpl#getInitialTime <em>Initial Time</em>}</li>
 *   <li>{@link finitestatemachines.impl.TransitionImpl#getFinalTime <em>Final Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TransitionImpl extends NamedElementImpl implements Transition {
	...
	public void setTarget(State newTarget) {
		if (newTarget != target) {
			...
			if (target != null)
				msgs = ((InternalEObject)target).eInverseRemove(this, FinitestatemachinesPackage.STATE__INCOMING, State.class, msgs);
			if (newTarget != null)
				msgs = ((InternalEObject)newTarget).eInverseAdd(this, FinitestatemachinesPackage.STATE__INCOMING, State.class, msgs);
	...
	public void setSource(State newSource) {
		if (newSource != source) {
			NotificationChain msgs = null;
			if (source != null)
				msgs = ((InternalEObject)source).eInverseRemove(this, FinitestatemachinesPackage.STATE__OUTGOING, State.class, msgs);
			if (newSource != null)
				msgs = ((InternalEObject)newSource).eInverseAdd(this, FinitestatemachinesPackage.STATE__OUTGOING, State.class, msgs);
