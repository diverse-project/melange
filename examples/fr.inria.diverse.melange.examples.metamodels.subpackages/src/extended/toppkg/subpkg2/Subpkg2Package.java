 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see extended.toppkg.subpkg2.Subpkg2Factory
 * @model kind="package"
 * @generated
 */
public interface Subpkg2Package extends EPackage {
	 ...
	 * @generated
	 */
	Subpkg2Package eINSTANCE = extended.toppkg.subpkg2.impl.Subpkg2PackageImpl.init();

	/**
	 * The meta object id for the '{@link extended.toppkg.subpkg2.impl.Subpkg2Class1Impl <em>Class1</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see extended.toppkg.subpkg2.impl.Subpkg2Class1Impl
	 * @see extended.toppkg.subpkg2.impl.Subpkg2PackageImpl#getSubpkg2Class1()
	 * @generated
	 */
	...
	/**
	 * The meta object id for the '{@link extended.toppkg.subpkg2.impl.Subpkg2Class2Impl <em>Class2</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see extended.toppkg.subpkg2.impl.Subpkg2Class2Impl
	 * @see extended.toppkg.subpkg2.impl.Subpkg2PackageImpl#getSubpkg2Class2()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link extended.toppkg.subpkg2.Subpkg2Class1 <em>Class1</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Class1</em>'.
	 * @see extended.toppkg.subpkg2.Subpkg2Class1
	 * @generated
	 */
	EClass getSubpkg2Class1();

	/**
	 * Returns the meta object for the containment reference list '{@link extended.toppkg.subpkg2.Subpkg2Class1#getMySubpkg2Class2 <em>My Subpkg2 Class2</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>My Subpkg2 Class2</em>'.
	 * @see extended.toppkg.subpkg2.Subpkg2Class1#getMySubpkg2Class2()
	...
	/**
	 * Returns the meta object for class '{@link extended.toppkg.subpkg2.Subpkg2Class2 <em>Class2</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Class2</em>'.
	 * @see extended.toppkg.subpkg2.Subpkg2Class2
	 * @generated
	 */
	EClass getSubpkg2Class2();

	/**
	 * Returns the meta object for the containment reference list '{@link extended.toppkg.subpkg2.Subpkg2Class2#getMySubpkg3Class1 <em>My Subpkg3 Class1</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>My Subpkg3 Class1</em>'.
	 * @see extended.toppkg.subpkg2.Subpkg2Class2#getMySubpkg3Class1()
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link extended.toppkg.subpkg2.impl.Subpkg2Class1Impl <em>Class1</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see extended.toppkg.subpkg2.impl.Subpkg2Class1Impl
		 * @see extended.toppkg.subpkg2.impl.Subpkg2PackageImpl#getSubpkg2Class1()
		...
		/**
		 * The meta object literal for the '{@link extended.toppkg.subpkg2.impl.Subpkg2Class2Impl <em>Class2</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see extended.toppkg.subpkg2.impl.Subpkg2Class2Impl
		 * @see extended.toppkg.subpkg2.impl.Subpkg2PackageImpl#getSubpkg2Class2()
