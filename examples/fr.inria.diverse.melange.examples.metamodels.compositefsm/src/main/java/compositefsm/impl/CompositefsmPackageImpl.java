...
import compositefsm.CompositefsmFactory;
 ...
 * @generated
 */
public class CompositefsmPackageImpl extends EPackageImpl implements CompositefsmPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see compositefsm.CompositefsmPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private CompositefsmPackageImpl() {
		super(eNS_URI, CompositefsmFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link CompositefsmPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static CompositefsmPackage init() {
		if (isInited) return (CompositefsmPackage)EPackage.Registry.INSTANCE.getEPackage(CompositefsmPackage.eNS_URI);

		// Obtain or create and register package
		CompositefsmPackageImpl theCompositefsmPackage = (CompositefsmPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof CompositefsmPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new CompositefsmPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theCompositefsmPackage.createPackageContents();

		// Initialize created meta-data
		theCompositefsmPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theCompositefsmPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(CompositefsmPackage.eNS_URI, theCompositefsmPackage);
		return theCompositefsmPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getState_SuperState() {
	 ...
	 * @generated
	 */
	public CompositefsmFactory getCompositefsmFactory() {
		return (CompositefsmFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(stateEClass, STATE__SUPER_STATE);
	...
	public void initializePackageContents() {
		...
		initEClass(fsmEClass, compositefsm.FSM.class, "FSM", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFSM_OwnedState(), this.getState(), this.getState_OwningFSM(), "ownedState", null, 0, -1, compositefsm.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFSM_InitialState(), this.getState(), null, "initialState", null, 1, 1, compositefsm.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFSM_FinalState(), this.getState(), null, "finalState", null, 1, -1, compositefsm.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getState_SubStates(), this.getState(), this.getState_SuperState(), "subStates", null, 0, -1, State.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getState_SuperState(), this.getState(), this.getState_SubStates(), "superState", null, 0, 1, State.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
