...
public class EDataTypeImpl extends EClassifierImpl implements EDataType {
	...
	protected EClass eStaticClass() {
		return ActivitydiagramPackage.eINSTANCE.getEDataType();
	}
	...
	public void setSerializable(boolean newSerializable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivitydiagramPackage.EDATA_TYPE__SERIALIZABLE, oldSerializable, serializable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivitydiagramPackage.EDATA_TYPE__SERIALIZABLE:
