...
public class LuaStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.xtext.lua.LuaRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://lua/1.0")) {
		EPackage.Registry.INSTANCE.put("http://lua/1.0", org.xtext.lua.lua.LuaPackage.eINSTANCE);
	}
