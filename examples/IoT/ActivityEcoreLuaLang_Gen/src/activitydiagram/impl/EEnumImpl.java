...
public class EEnumImpl extends EDataTypeImpl implements EEnum {
	...
	protected EClass eStaticClass() {
		return ActivitydiagramPackage.eINSTANCE.getEEnum();
	}
	...
	public EList<EEnumLiteral> getELiterals() {
		if (eLiterals == null) {
			eLiterals = new EObjectContainmentWithInverseEList<EEnumLiteral>(EEnumLiteral.class, this, ActivitydiagramPackage.EENUM__ELITERALS, ActivitydiagramPackage.EENUM_LITERAL__EENUM);
		}
		return eLiterals;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivitydiagramPackage.EENUM__ELITERALS:
