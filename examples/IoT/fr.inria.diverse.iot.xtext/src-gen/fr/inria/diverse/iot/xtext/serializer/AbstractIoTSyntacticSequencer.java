...
public abstract class AbstractIoTSyntacticSequencer extends AbstractSyntacticSequencer {
	 ...
	 *     (rule start) (ambiguity) variable=ValidID
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     parameters+=ValidID (ambiguity) ')' body=Block
	 *     parameters+=ValidID (ambiguity) varArgs?='...'
	 */
