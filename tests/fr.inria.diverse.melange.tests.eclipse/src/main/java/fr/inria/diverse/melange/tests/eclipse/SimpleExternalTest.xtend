...
public class SimpleExternalTest extends AbstractXtextTests
{
	...
	static final String MELANGE_FILE = PROJECT_NAME+"/src/fr/inria/diverse/melange/tests/extern/main/Main.melange"
	...
	override setUp() {
		...
		if (!helper.projectExists(PROJECT_NAME)) {
			...
			melangeProject = helper.deployMelangeProject(PROJECT_NAME,"tests-inputs/fr.inria.diverse.melange.tests.extern.main.zip")
	...
	def void test0NoErrorsInWorkspace() {
		...
		helper.assertProjectExists("fr.inria.diverse.melange.tests.extern.main.xfsm")
		helper.assertProjectDoesntExists("fr.inria.diverse.melange.tests.extern.main.fsm")
	}
	...
	def void test1Generation() {
		...
		val MELANGE_PKG = "fr/inria/diverse/melange/tests/extern/main"
