 ...
 * @generated
 */
public class Subpkg3Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Subpkg3Package.SUBPKG3_CLASS1: {
				Subpkg3Class1 subpkg3Class1 = (Subpkg3Class1)theEObject;
				T result = caseSubpkg3Class1(subpkg3Class1);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Subpkg3Package.SUBPKG3_CLASS2: {
				Subpkg3Class2 subpkg3Class2 = (Subpkg3Class2)theEObject;
				T result = caseSubpkg3Class2(subpkg3Class2);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Subpkg3Package.CLASS_A: {
	 ...
	 * @generated
	 */
	public T caseSubpkg3Class1(Subpkg3Class1 object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseSubpkg3Class2(Subpkg3Class2 object) {
		return null;
	}
