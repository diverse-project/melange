 ...
 * </p>
 * <ul>
 *   <li>{@link toppkg.impl.ClassAImpl#getToClassA <em>To Class A</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClassAImpl extends MinimalEObjectImpl.Container implements ClassA {
	 ...
	 * @ordered
	 */
	protected toppkg.subpkg2.subpkg3.ClassA toClassA;
	 ...
	 * @generated
	 */
	public toppkg.subpkg2.subpkg3.ClassA getToClassA() {
		if (toClassA != null && toClassA.eIsProxy()) {
			InternalEObject oldToClassA = (InternalEObject)toClassA;
			toClassA = (toppkg.subpkg2.subpkg3.ClassA)eResolveProxy(oldToClassA);
	 ...
	 * @generated
	 */
	public toppkg.subpkg2.subpkg3.ClassA basicGetToClassA() {
		return toClassA;
	}
	 ...
	 * @generated
	 */
	public void setToClassA(toppkg.subpkg2.subpkg3.ClassA newToClassA) {
		toppkg.subpkg2.subpkg3.ClassA oldToClassA = toClassA;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ToppkgPackage.CLASS_A__TO_CLASS_A:
				setToClassA((toppkg.subpkg2.subpkg3.ClassA)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ToppkgPackage.CLASS_A__TO_CLASS_A:
				setToClassA((toppkg.subpkg2.subpkg3.ClassA)null);
				return;
		}
