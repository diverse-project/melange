...
public class SubpackageAdapterFactory extends AdapterFactoryImpl {
	...
	protected SubpackageSwitch<Adapter> modelSwitch =
		new SubpackageSwitch<Adapter>() {
			...
			@Override
			public Adapter caseSuperB(SuperB object) {
				return createSuperBAdapter();
			}
			@Override
			public Adapter caseSubA(SubA object) {
				return createSubAAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link some.basepackage.root.subpackage.ClassB <em>Class B</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link some.basepackage.root.subpackage.SuperB <em>Super B</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSuperBAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link some.basepackage.root.subpackage.SubA <em>Sub A</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSubAAdapter() {
		return null;
	}
