...
public class RootPackageImpl extends EPackageImpl implements RootPackage {
	 ...
	 * @generated
	 */
	private EClass superAEClass = null;
	...
	public void createPackageContents() {
		...
		superAEClass = createEClass(SUPER_A);

		aEClass = createEClass(A);
		createEReference(aEClass, A__TO_B);
	...
	public void initializePackageContents() {
		...
		aEClass.getESuperTypes().add(this.getSuperA());
		subAEClass.getESuperTypes().add(this.getA());

		// Initialize classes, features, and operations; add parameters
		initEClass(superAEClass, SuperA.class, "SuperA", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(aEClass, root.A.class, "A", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getA_ToB(), this.getB(), null, "toB", null, 0, 1, root.A.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(subAEClass, SubA.class, "SubA", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(bEClass, root.B.class, "B", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
