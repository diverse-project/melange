...
class InheritanceOverridingTest
{
	...
	def void testLangA() {
		...
		assertEquals("tests-inputs/metamodels/FSM.ecore", a.syntax.ecoreUri)
		assertEquals(1, a.syntax.genmodelUris.size)
		assertEquals("tests-inputs/metamodels/FSM.genmodel", a.syntax.genmodelUris.head)
		assertFalse(a.generatedByMelange)
