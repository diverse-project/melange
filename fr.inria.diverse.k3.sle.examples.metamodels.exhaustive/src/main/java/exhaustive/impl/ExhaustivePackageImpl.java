...
public class ExhaustivePackageImpl extends EPackageImpl implements ExhaustivePackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getAttributesTest_LowerBound1(), ecorePackage.getEIntegerObject(), "lowerBound1", null, 0, 1, AttributesTest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAttributesTest_LowerBound2(), ecorePackage.getEShortObject(), "lowerBound2", null, 0, 1, AttributesTest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAttributesTest_UpperBound2(), ecorePackage.getEString(), "upperBound2", null, 0, 1, AttributesTest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
