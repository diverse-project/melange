 ...
 */
package fr.inria.diverse.melange.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import fr.inria.diverse.melange.ide.contentassist.antlr.internal.InternalMelangeParser;
...
public class MelangeParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(MelangeGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MelangeGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getElementAccess().getAlternatives(), "rule__Element__Alternatives");
			builder.put(grammarAccess.getLanguageAccess().getAlternatives_1_2(), "rule__Language__Alternatives_1_2");
			builder.put(grammarAccess.getOperatorAccess().getAlternatives(), "rule__Operator__Alternatives");
			builder.put(grammarAccess.getWeaveAccess().getAlternatives(), "rule__Weave__Alternatives");
			...
			builder.put(grammarAccess.getModelTypingSpaceAccess().getGroup(), "rule__ModelTypingSpace__Group__0");
			builder.put(grammarAccess.getElementAccess().getGroup_1(), "rule__Element__Group_1__0");
			builder.put(grammarAccess.getLanguageAccess().getGroup_0(), "rule__Language__Group_0__0");
			builder.put(grammarAccess.getLanguageAccess().getGroup_0_2(), "rule__Language__Group_0_2__0");
			builder.put(grammarAccess.getLanguageAccess().getGroup_0_2_2(), "rule__Language__Group_0_2_2__0");
			builder.put(grammarAccess.getLanguageAccess().getGroup_0_3(), "rule__Language__Group_0_3__0");
			builder.put(grammarAccess.getLanguageAccess().getGroup_0_3_2(), "rule__Language__Group_0_3_2__0");
			builder.put(grammarAccess.getLanguageAccess().getGroup_0_4(), "rule__Language__Group_0_4__0");
			builder.put(grammarAccess.getLanguageAccess().getGroup_0_4_2(), "rule__Language__Group_0_4_2__0");
			builder.put(grammarAccess.getLanguageAccess().getGroup_1(), "rule__Language__Group_1__0");
			builder.put(grammarAccess.getLanguageAccess().getGroup_1_2_0(), "rule__Language__Group_1_2_0__0");
			builder.put(grammarAccess.getLanguageAccess().getGroup_1_2_1(), "rule__Language__Group_1_2_1__0");
			builder.put(grammarAccess.getLanguageAccess().getGroup_2(), "rule__Language__Group_2__0");
			builder.put(grammarAccess.getLanguageAccess().getGroup_2_2(), "rule__Language__Group_2_2__0");
			builder.put(grammarAccess.getLanguageAccess().getGroup_3(), "rule__Language__Group_3__0");
			builder.put(grammarAccess.getLanguageAccess().getGroup_3_2(), "rule__Language__Group_3_2__0");
			builder.put(grammarAccess.getLanguageAccess().getGroup_4(), "rule__Language__Group_4__0");
			builder.put(grammarAccess.getLanguageAccess().getGroup_4_2(), "rule__Language__Group_4_2__0");
			...
			builder.put(grammarAccess.getLanguageAccess().getGroup_7(), "rule__Language__Group_7__0");
			builder.put(grammarAccess.getLanguageAccess().getGroup_7_2(), "rule__Language__Group_7_2__0");
			builder.put(grammarAccess.getLanguageAccess().getGroup_8(), "rule__Language__Group_8__0");
			builder.put(grammarAccess.getAnnotationAccess().getGroup(), "rule__Annotation__Group__0");
			builder.put(grammarAccess.getExternalLanguageAccess().getGroup_0(), "rule__ExternalLanguage__Group_0__0");
			builder.put(grammarAccess.getExternalLanguageAccess().getGroup_0_2(), "rule__ExternalLanguage__Group_0_2__0");
			builder.put(grammarAccess.getExternalLanguageAccess().getGroup_0_2_2(), "rule__ExternalLanguage__Group_0_2_2__0");
			builder.put(grammarAccess.getExternalLanguageAccess().getGroup_2(), "rule__ExternalLanguage__Group_2__0");
			builder.put(grammarAccess.getExternalLanguageAccess().getGroup_2_2(), "rule__ExternalLanguage__Group_2_2__0");
			builder.put(grammarAccess.getExternalLanguageAccess().getGroup_3(), "rule__ExternalLanguage__Group_3__0");
			builder.put(grammarAccess.getExternalLanguageAccess().getGroup_3_2(), "rule__ExternalLanguage__Group_3_2__0");
			builder.put(grammarAccess.getExternalLanguageAccess().getGroup_4(), "rule__ExternalLanguage__Group_4__0");
			builder.put(grammarAccess.getExternalLanguageAccess().getGroup_4_2(), "rule__ExternalLanguage__Group_4_2__0");
			builder.put(grammarAccess.getExternalLanguageAccess().getGroup_5(), "rule__ExternalLanguage__Group_5__0");
			builder.put(grammarAccess.getExternalLanguageAccess().getGroup_6(), "rule__ExternalLanguage__Group_6__0");
			builder.put(grammarAccess.getExternalLanguageAccess().getGroup_7(), "rule__ExternalLanguage__Group_7__0");
			builder.put(grammarAccess.getExternalLanguageAccess().getGroup_7_0(), "rule__ExternalLanguage__Group_7_0__0");
			builder.put(grammarAccess.getExternalLanguageAccess().getGroup_7_0_2(), "rule__ExternalLanguage__Group_7_0_2__0");
			builder.put(grammarAccess.getImportDslAccess().getGroup(), "rule__ImportDsl__Group__0");
			builder.put(grammarAccess.getEcoreModelTypeAccess().getGroup_0(), "rule__EcoreModelType__Group_0__0");
			builder.put(grammarAccess.getEcoreModelTypeAccess().getGroup_1(), "rule__EcoreModelType__Group_1__0");
			builder.put(grammarAccess.getEcoreModelTypeAccess().getGroup_1_0(), "rule__EcoreModelType__Group_1_0__0");
			builder.put(grammarAccess.getXbaseTransformationAccess().getGroup(), "rule__XbaseTransformation__Group__0");
			builder.put(grammarAccess.getXbaseTransformationAccess().getGroup_5(), "rule__XbaseTransformation__Group_5__0");
			builder.put(grammarAccess.getXbaseTransformationAccess().getGroup_5_1(), "rule__XbaseTransformation__Group_5_1__0");
			builder.put(grammarAccess.getMappingAccess().getGroup(), "rule__Mapping__Group__0");
			builder.put(grammarAccess.getPackageMappingAccess().getGroup(), "rule__PackageMapping__Group__0");
			builder.put(grammarAccess.getPackageMappingAccess().getGroup_3(), "rule__PackageMapping__Group_3__0");
			builder.put(grammarAccess.getClassMappingAccess().getGroup(), "rule__ClassMapping__Group__0");
			builder.put(grammarAccess.getClassMappingAccess().getGroup_3(), "rule__ClassMapping__Group_3__0");
			builder.put(grammarAccess.getPropertyMappingAccess().getGroup(), "rule__PropertyMapping__Group__0");
			builder.put(grammarAccess.getImportAccess().getGroup(), "rule__Import__Group__0");
			builder.put(grammarAccess.getImportAccess().getGroup_2(), "rule__Import__Group_2__0");
			builder.put(grammarAccess.getImportAccess().getGroup_2_1(), "rule__Import__Group_2_1__0");
			builder.put(grammarAccess.getImportAccess().getGroup_2_1_1(), "rule__Import__Group_2_1_1__0");
			...
			builder.put(grammarAccess.getExternalImportAccess().getGroup_2(), "rule__ExternalImport__Group_2__0");
			builder.put(grammarAccess.getExternalImportAccess().getGroup_2_1(), "rule__ExternalImport__Group_2_1__0");
			builder.put(grammarAccess.getExternalImportAccess().getGroup_2_1_1(), "rule__ExternalImport__Group_2_1_1__0");
			builder.put(grammarAccess.getMergeAccess().getGroup(), "rule__Merge__Group__0");
			builder.put(grammarAccess.getMergeAccess().getGroup_2(), "rule__Merge__Group_2__0");
			builder.put(grammarAccess.getSliceAccess().getGroup(), "rule__Slice__Group__0");
			builder.put(grammarAccess.getSliceAccess().getGroup_5(), "rule__Slice__Group_5__0");
			builder.put(grammarAccess.getSliceAccess().getGroup_7(), "rule__Slice__Group_7__0");
			builder.put(grammarAccess.getAspectTypeRefAccess().getGroup(), "rule__AspectTypeRef__Group__0");
			builder.put(grammarAccess.getAspectWildcardAccess().getGroup(), "rule__AspectWildcard__Group__0");
			...
			builder.put(grammarAccess.getModelTypingSpaceAccess().getNameAssignment_1(), "rule__ModelTypingSpace__NameAssignment_1");
			builder.put(grammarAccess.getModelTypingSpaceAccess().getImportsAssignment_2(), "rule__ModelTypingSpace__ImportsAssignment_2");
			builder.put(grammarAccess.getModelTypingSpaceAccess().getElementsAssignment_3(), "rule__ModelTypingSpace__ElementsAssignment_3");
			builder.put(grammarAccess.getLanguageAccess().getNameAssignment_0_1(), "rule__Language__NameAssignment_0_1");
			builder.put(grammarAccess.getLanguageAccess().getOperatorsAssignment_0_2_1(), "rule__Language__OperatorsAssignment_0_2_1");
			builder.put(grammarAccess.getLanguageAccess().getOperatorsAssignment_0_2_2_1(), "rule__Language__OperatorsAssignment_0_2_2_1");
			builder.put(grammarAccess.getLanguageAccess().getImplementsAssignment_0_3_1(), "rule__Language__ImplementsAssignment_0_3_1");
			builder.put(grammarAccess.getLanguageAccess().getImplementsAssignment_0_3_2_1(), "rule__Language__ImplementsAssignment_0_3_2_1");
			builder.put(grammarAccess.getLanguageAccess().getRequiresAssignment_0_4_1(), "rule__Language__RequiresAssignment_0_4_1");
			builder.put(grammarAccess.getLanguageAccess().getRequiresAssignment_0_4_2_1(), "rule__Language__RequiresAssignment_0_4_2_1");
			builder.put(grammarAccess.getLanguageAccess().getOperatorsAssignment_0_6(), "rule__Language__OperatorsAssignment_0_6");
			builder.put(grammarAccess.getLanguageAccess().getResourceTypeAssignment_1_1(), "rule__Language__ResourceTypeAssignment_1_1");
			builder.put(grammarAccess.getLanguageAccess().getResourceUriAssignment_1_2_0_1(), "rule__Language__ResourceUriAssignment_1_2_0_1");
			builder.put(grammarAccess.getLanguageAccess().getXtextSetupRefAssignment_1_2_1_1(), "rule__Language__XtextSetupRefAssignment_1_2_1_1");
			builder.put(grammarAccess.getLanguageAccess().getXtextAssignment_2_1(), "rule__Language__XtextAssignment_2_1");
			builder.put(grammarAccess.getLanguageAccess().getXtextAssignment_2_2_1(), "rule__Language__XtextAssignment_2_2_1");
			builder.put(grammarAccess.getLanguageAccess().getSiriusAssignment_3_1(), "rule__Language__SiriusAssignment_3_1");
			builder.put(grammarAccess.getLanguageAccess().getSiriusAssignment_3_2_1(), "rule__Language__SiriusAssignment_3_2_1");
			builder.put(grammarAccess.getLanguageAccess().getEclAssignment_4_1(), "rule__Language__EclAssignment_4_1");
			builder.put(grammarAccess.getLanguageAccess().getEclAssignment_4_2_1(), "rule__Language__EclAssignment_4_2_1");
			builder.put(grammarAccess.getLanguageAccess().getXmofAssignment_5_1(), "rule__Language__XmofAssignment_5_1");
			builder.put(grammarAccess.getLanguageAccess().getFileExtensionAssignment_6_1(), "rule__Language__FileExtensionAssignment_6_1");
			builder.put(grammarAccess.getLanguageAccess().getExactTypeNameAssignment_7_1(), "rule__Language__ExactTypeNameAssignment_7_1");
			builder.put(grammarAccess.getLanguageAccess().getExactTypeUriAssignment_7_2_1(), "rule__Language__ExactTypeUriAssignment_7_2_1");
			builder.put(grammarAccess.getLanguageAccess().getAnnotationsAssignment_8_0(), "rule__Language__AnnotationsAssignment_8_0");
			builder.put(grammarAccess.getAnnotationAccess().getKeyAssignment_1(), "rule__Annotation__KeyAssignment_1");
			builder.put(grammarAccess.getAnnotationAccess().getValueAssignment_3(), "rule__Annotation__ValueAssignment_3");
			builder.put(grammarAccess.getExternalLanguageAccess().getNameAssignment_0_1(), "rule__ExternalLanguage__NameAssignment_0_1");
			builder.put(grammarAccess.getExternalLanguageAccess().getImplementsAssignment_0_2_1(), "rule__ExternalLanguage__ImplementsAssignment_0_2_1");
			builder.put(grammarAccess.getExternalLanguageAccess().getImplementsAssignment_0_2_2_1(), "rule__ExternalLanguage__ImplementsAssignment_0_2_2_1");
			builder.put(grammarAccess.getExternalLanguageAccess().getOperatorsAssignment_0_4(), "rule__ExternalLanguage__OperatorsAssignment_0_4");
			builder.put(grammarAccess.getExternalLanguageAccess().getOperatorsAssignment_1(), "rule__ExternalLanguage__OperatorsAssignment_1");
			builder.put(grammarAccess.getExternalLanguageAccess().getXtextAssignment_2_1(), "rule__ExternalLanguage__XtextAssignment_2_1");
			builder.put(grammarAccess.getExternalLanguageAccess().getXtextAssignment_2_2_1(), "rule__ExternalLanguage__XtextAssignment_2_2_1");
			builder.put(grammarAccess.getExternalLanguageAccess().getSiriusAssignment_3_1(), "rule__ExternalLanguage__SiriusAssignment_3_1");
			builder.put(grammarAccess.getExternalLanguageAccess().getSiriusAssignment_3_2_1(), "rule__ExternalLanguage__SiriusAssignment_3_2_1");
			builder.put(grammarAccess.getExternalLanguageAccess().getEclAssignment_4_1(), "rule__ExternalLanguage__EclAssignment_4_1");
			builder.put(grammarAccess.getExternalLanguageAccess().getEclAssignment_4_2_1(), "rule__ExternalLanguage__EclAssignment_4_2_1");
			builder.put(grammarAccess.getExternalLanguageAccess().getXmofAssignment_5_1(), "rule__ExternalLanguage__XmofAssignment_5_1");
			builder.put(grammarAccess.getExternalLanguageAccess().getFileExtensionAssignment_6_1(), "rule__ExternalLanguage__FileExtensionAssignment_6_1");
			builder.put(grammarAccess.getExternalLanguageAccess().getExactTypeNameAssignment_7_0_1(), "rule__ExternalLanguage__ExactTypeNameAssignment_7_0_1");
			builder.put(grammarAccess.getExternalLanguageAccess().getExactTypeUriAssignment_7_0_2_1(), "rule__ExternalLanguage__ExactTypeUriAssignment_7_0_2_1");
			builder.put(grammarAccess.getImportDslAccess().getDslAssignment_1(), "rule__ImportDsl__DslAssignment_1");
			builder.put(grammarAccess.getEcoreModelTypeAccess().getNameAssignment_0_1(), "rule__EcoreModelType__NameAssignment_0_1");
			builder.put(grammarAccess.getEcoreModelTypeAccess().getEcoreUriAssignment_0_4(), "rule__EcoreModelType__EcoreUriAssignment_0_4");
			builder.put(grammarAccess.getEcoreModelTypeAccess().getMtUriAssignment_1_0_1(), "rule__EcoreModelType__MtUriAssignment_1_0_1");
			builder.put(grammarAccess.getXbaseTransformationAccess().getMainAssignment_0(), "rule__XbaseTransformation__MainAssignment_0");
			builder.put(grammarAccess.getXbaseTransformationAccess().getReturnTypeRefAssignment_2(), "rule__XbaseTransformation__ReturnTypeRefAssignment_2");
			builder.put(grammarAccess.getXbaseTransformationAccess().getNameAssignment_3(), "rule__XbaseTransformation__NameAssignment_3");
			builder.put(grammarAccess.getXbaseTransformationAccess().getParametersAssignment_5_0(), "rule__XbaseTransformation__ParametersAssignment_5_0");
			builder.put(grammarAccess.getXbaseTransformationAccess().getParametersAssignment_5_1_1(), "rule__XbaseTransformation__ParametersAssignment_5_1_1");
			builder.put(grammarAccess.getXbaseTransformationAccess().getBodyAssignment_7(), "rule__XbaseTransformation__BodyAssignment_7");
			builder.put(grammarAccess.getMappingAccess().getFromAssignment_1(), "rule__Mapping__FromAssignment_1");
			builder.put(grammarAccess.getMappingAccess().getToAssignment_3(), "rule__Mapping__ToAssignment_3");
			builder.put(grammarAccess.getMappingAccess().getRulesAssignment_5(), "rule__Mapping__RulesAssignment_5");
			builder.put(grammarAccess.getPackageMappingAccess().getFromAssignment_0(), "rule__PackageMapping__FromAssignment_0");
			builder.put(grammarAccess.getPackageMappingAccess().getToAssignment_2(), "rule__PackageMapping__ToAssignment_2");
			builder.put(grammarAccess.getPackageMappingAccess().getClassesAssignment_3_1(), "rule__PackageMapping__ClassesAssignment_3_1");
			builder.put(grammarAccess.getClassMappingAccess().getFromAssignment_0(), "rule__ClassMapping__FromAssignment_0");
			builder.put(grammarAccess.getClassMappingAccess().getToAssignment_2(), "rule__ClassMapping__ToAssignment_2");
			builder.put(grammarAccess.getClassMappingAccess().getPropertiesAssignment_3_1(), "rule__ClassMapping__PropertiesAssignment_3_1");
			builder.put(grammarAccess.getPropertyMappingAccess().getFromAssignment_0(), "rule__PropertyMapping__FromAssignment_0");
			builder.put(grammarAccess.getPropertyMappingAccess().getToAssignment_2(), "rule__PropertyMapping__ToAssignment_2");
			builder.put(grammarAccess.getImportAccess().getEcoreUriAssignment_1(), "rule__Import__EcoreUriAssignment_1");
			builder.put(grammarAccess.getImportAccess().getGenmodelUrisAssignment_2_1_0(), "rule__Import__GenmodelUrisAssignment_2_1_0");
			builder.put(grammarAccess.getImportAccess().getGenmodelUrisAssignment_2_1_1_1(), "rule__Import__GenmodelUrisAssignment_2_1_1_1");
			builder.put(grammarAccess.getImportAccess().getMappingRulesAssignment_3_2(), "rule__Import__MappingRulesAssignment_3_2");
			builder.put(grammarAccess.getExternalImportAccess().getEcoreUriAssignment_1(), "rule__ExternalImport__EcoreUriAssignment_1");
			builder.put(grammarAccess.getExternalImportAccess().getGenmodelUrisAssignment_2_1_0(), "rule__ExternalImport__GenmodelUrisAssignment_2_1_0");
			builder.put(grammarAccess.getExternalImportAccess().getGenmodelUrisAssignment_2_1_1_1(), "rule__ExternalImport__GenmodelUrisAssignment_2_1_1_1");
			builder.put(grammarAccess.getMergeAccess().getTargetLanguageAssignment_1(), "rule__Merge__TargetLanguageAssignment_1");
			builder.put(grammarAccess.getMergeAccess().getMappingRulesAssignment_2_2(), "rule__Merge__MappingRulesAssignment_2_2");
			builder.put(grammarAccess.getSliceAccess().getTargetLanguageAssignment_1(), "rule__Slice__TargetLanguageAssignment_1");
			builder.put(grammarAccess.getSliceAccess().getRootsAssignment_4(), "rule__Slice__RootsAssignment_4");
			builder.put(grammarAccess.getSliceAccess().getRootsAssignment_5_1(), "rule__Slice__RootsAssignment_5_1");
			builder.put(grammarAccess.getSliceAccess().getMappingRulesAssignment_7_2(), "rule__Slice__MappingRulesAssignment_7_2");
			builder.put(grammarAccess.getInheritAccess().getTargetLanguageAssignment(), "rule__Inherit__TargetLanguageAssignment");
			builder.put(grammarAccess.getAspectTypeRefAccess().getAspectTypeRefAssignment_1(), "rule__AspectTypeRef__AspectTypeRefAssignment_1");
			builder.put(grammarAccess.getAspectWildcardAccess().getAspectWildcardImportAssignment_1(), "rule__AspectWildcard__AspectWildcardImportAssignment_1");
			...
			builder.put(grammarAccess.getLanguageAccess().getUnorderedGroup(), "rule__Language__UnorderedGroup");
			builder.put(grammarAccess.getExternalLanguageAccess().getUnorderedGroup(), "rule__ExternalLanguage__UnorderedGroup");
			builder.put(grammarAccess.getEcoreModelTypeAccess().getUnorderedGroup(), "rule__EcoreModelType__UnorderedGroup");
		}
	}
	...
	@Override
	protected InternalMelangeParser createParser() {
		InternalMelangeParser result = new InternalMelangeParser(null);
