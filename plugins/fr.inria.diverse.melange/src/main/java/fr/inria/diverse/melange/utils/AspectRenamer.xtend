...
class AspectRenamer {
	 ...
	 */
	def void processRenaming(List<Aspect> aspects,
		                     Language l,
		                     List<Pair<String,String>> classRenaming,
		                     List<Pair<String,String>> packageRenaming,
		                     List<Pair<String,String>> propertiesRenaming,
		                     SetMultimap<String,Pair<String,String>> propertiesAspectRenaming
							){
		...
		aspects.forEach[asp | 
			...
			processRenaming(targetClass, aspectNamespace, classRenaming, packageRenaming, propertiesRenaming, propertiesAspectRenaming)
		]
	}
	 ...
	 */
	private def void processRenaming(String targetClass,
		                     IPackageFragment aspectNamespace,
		                     List<Pair<String,String>> classRenaming,
		                     List<Pair<String,String>> packageRenaming,
		                     List<Pair<String,String>> propertiesRenaming,
		                     SetMultimap<String,Pair<String,String>> propertiesAspectRenaming
...
//		parser.setResolveBindings(true) --not working
	 ...
	 * Return the selected rules and group them by Aspect.
	 * <br>
	 * AspectName -> (package.sourceClass.property, package.targetClass.property)
	 */
