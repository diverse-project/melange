...
import k3transfofootprint.orgeclipsextextxbaseXNullLiteralAspectXNullLiteralAspectProperties;
...
public class orgeclipsextextxbaseXNullLiteralAspect extends orgeclipsextextxbaseXExpressionAspect {
  ...
  public static void _visitToAddClasses(final XNullLiteral _self, final K3TransfoFootprint theSlicer) {
    _self_ = k3transfofootprint.orgeclipsextextxbaseXNullLiteralAspectXNullLiteralAspectContext.getSelf(_self);
  ...
  public static orgeclipsextextxbaseXNullLiteralAspectXNullLiteralAspectProperties _self_;
  ...
  protected static void _privk3__visitToAddClasses(final XNullLiteral _self, final K3TransfoFootprint theSlicer) {
    orgeclipsextextxbaseXNullLiteralAspect.super__visitToAddClasses(_self, theSlicer);
  }
  ...
  protected static void _privk3__visitToAddRelations(final XNullLiteral _self, final K3TransfoFootprint theSlicer) {
    orgeclipsextextxbaseXNullLiteralAspect.super__visitToAddRelations(_self, theSlicer);
  }
}
