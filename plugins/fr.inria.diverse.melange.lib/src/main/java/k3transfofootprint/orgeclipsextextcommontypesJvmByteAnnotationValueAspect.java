...
import k3transfofootprint.orgeclipsextextcommontypesJvmByteAnnotationValueAspectJvmByteAnnotationValueAspectProperties;
...
public class orgeclipsextextcommontypesJvmByteAnnotationValueAspect extends orgeclipsextextcommontypesJvmAnnotationValueAspect {
  ...
  public static void _visitToAddClasses(final JvmByteAnnotationValue _self, final K3TransfoFootprint theSlicer) {
    _self_ = k3transfofootprint.orgeclipsextextcommontypesJvmByteAnnotationValueAspectJvmByteAnnotationValueAspectContext.getSelf(_self);
  ...
  public static orgeclipsextextcommontypesJvmByteAnnotationValueAspectJvmByteAnnotationValueAspectProperties _self_;
  ...
  protected static void _privk3__visitToAddClasses(final JvmByteAnnotationValue _self, final K3TransfoFootprint theSlicer) {
    orgeclipsextextcommontypesJvmByteAnnotationValueAspect.super__visitToAddClasses(_self, theSlicer);
  }
  ...
  protected static void _privk3__visitToAddRelations(final JvmByteAnnotationValue _self, final K3TransfoFootprint theSlicer) {
    orgeclipsextextcommontypesJvmByteAnnotationValueAspect.super__visitToAddRelations(_self, theSlicer);
  }
}
