...
@Aspect(className = XNumberLiteral.class, with = { orgeclipsextextxbaseXExpressionAspect.class })
@SuppressWarnings("all")
public class orgeclipsextextxbaseXNumberLiteralAspect extends orgeclipsextextxbaseXExpressionAspect {
  @OverrideAspectMethod
  public static void _visitToAddClasses(final XNumberLiteral _self, final K3TransfoFootprint theSlicer) {
    _self_ = k3transfofootprint.orgeclipsextextxbaseXNumberLiteralAspectXNumberLiteralAspectContext.getSelf(_self);
  ...
  public static orgeclipsextextxbaseXNumberLiteralAspectXNumberLiteralAspectProperties _self_;
  ...
  protected static void _privk3__visitToAddClasses(final XNumberLiteral _self, final K3TransfoFootprint theSlicer) {
    orgeclipsextextxbaseXNumberLiteralAspect.super__visitToAddClasses(_self, theSlicer);
  }
  ...
  protected static void _privk3__visitToAddRelations(final XNumberLiteral _self, final K3TransfoFootprint theSlicer) {
    orgeclipsextextxbaseXNumberLiteralAspect.super__visitToAddRelations(_self, theSlicer);
  }
}
