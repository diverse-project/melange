...
public class PuzzleSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PuzzlePackage.COMPOSITION: {
			...
			case PuzzlePackage.STATEMENT: {
				Statement statement = (Statement)theEObject;
				T result = caseStatement(statement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PuzzlePackage.VAR_DECL: {
			...
			case PuzzlePackage.EXPRESSION: {
				Expression expression = (Expression)theEObject;
				T result = caseExpression(expression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PuzzlePackage.LANGUAGE_REF: {
				LanguageRef languageRef = (LanguageRef)theEObject;
				T result = caseLanguageRef(languageRef);
				if (result == null) result = caseExpression(languageRef);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PuzzlePackage.VAR_REF: {
			...
			case PuzzlePackage.AGGREGATION: {
