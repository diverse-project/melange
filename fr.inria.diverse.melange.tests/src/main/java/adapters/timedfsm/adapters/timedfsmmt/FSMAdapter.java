...
public class FSMAdapter extends EObjectAdapter<FSM> implements adapters.timedfsmmt.FSM {
  ...
  public List<State> getOwnedState() {
    return fr.inria.diverse.melange.lib.ListAdapter.newInstance(adaptee.getOwnedState(), adapters.timedfsm.adapters.timedfsmmt.StateAdapter.class) ;
  }
  ...
  public List<State> getFinalState() {
    return fr.inria.diverse.melange.lib.ListAdapter.newInstance(adaptee.getFinalState(), adapters.timedfsm.adapters.timedfsmmt.StateAdapter.class) ;
  }
}
