...
public class TransitionAdapter extends EObjectAdapter<Transition> implements fr.inria.diverse.melange.tests.adapters.fsmmt.Transition {
  ...
  public void setSource(final State o) {
    adaptee.setSource(((fr.inria.diverse.melange.tests.adapters.timedfsm.adapters.fsmmt.StateAdapter) o).getAdaptee()) ;
  }
  ...
  public void setTarget(final State o) {
    adaptee.setTarget(((fr.inria.diverse.melange.tests.adapters.timedfsm.adapters.fsmmt.StateAdapter) o).getAdaptee()) ;
  }
}
