...
public class StateAdapter extends EObjectAdapter<State> implements fr.inria.diverse.melange.tests.adapters.fsmmt.State {
  ...
  public void setOwningFSM(final FSM o) {
    adaptee.setOwningFSM(((fr.inria.diverse.melange.tests.adapters.timedfsm.adapters.fsmmt.FSMAdapter) o).getAdaptee()) ;
  }
  
  public List<Transition> getOutgoingTransition() {
    return fr.inria.diverse.melange.lib.ListAdapter.newInstance(adaptee.getOutgoingTransition(), fr.inria.diverse.melange.tests.adapters.timedfsm.adapters.fsmmt.TransitionAdapter.class) ;
  }
  
  public List<Transition> getIncomingTransition() {
    return fr.inria.diverse.melange.lib.ListAdapter.newInstance(adaptee.getIncomingTransition(), fr.inria.diverse.melange.tests.adapters.timedfsm.adapters.fsmmt.TransitionAdapter.class) ;
  }
}
