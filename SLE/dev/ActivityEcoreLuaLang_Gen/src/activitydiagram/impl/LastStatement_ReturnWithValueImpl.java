 ...
 * <ul>
 *   <li>{@link activitydiagram.impl.LastStatement_ReturnWithValueImpl#getReturnValues <em>Return Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LastStatement_ReturnWithValueImpl extends LastStatement_ReturnImpl implements LastStatement_ReturnWithValue {
	...
	protected EClass eStaticClass() {
		return ActivitydiagramPackage.eINSTANCE.getLastStatement_ReturnWithValue();
	}
	...
	public EList<Expression> getReturnValues() {
		if (returnValues == null) {
			returnValues = new EObjectContainmentEList<Expression>(Expression.class, this, ActivitydiagramPackage.LAST_STATEMENT_RETURN_WITH_VALUE__RETURN_VALUES);
		}
		return returnValues;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivitydiagramPackage.LAST_STATEMENT_RETURN_WITH_VALUE__RETURN_VALUES:
