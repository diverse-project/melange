...
public class EAnnotationImpl extends EModelElementImpl implements EAnnotation {
	...
	protected EClass eStaticClass() {
		return ActivitydiagramPackage.eINSTANCE.getEAnnotation();
	}
	...
	public EMap<String, String> getDetails() {
		if (details == null) {
			details = new EcoreEMap<String,String>(ActivitydiagramPackage.eINSTANCE.getEStringToStringMapEntry(), EStringToStringMapEntryImpl.class, this, ActivitydiagramPackage.EANNOTATION__DETAILS);
		}
		return details;
	}
